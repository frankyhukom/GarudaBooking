                ...
                @foreach ($flights as $flight )
                                        ...
                                        @if(!$loop->last)
                                            <div class="time flex flex-col items-center w-[83px]">
                                                ...
                                                <p class="text-xs leading-[18px] text-garuda-grey">
                                                    {{ number_format($segment->time->diffInHours($flight->segments[$loop->index + 1]->time), 0) }} hours</p>
                                                <div class="h-8 border border-garuda-black border-dashed"></div>
                                            </div>
                                        @endif
                                    @endforeach
                    ...
                    @else
                        <div
                            ...
                            <label class="accordion-trigger flex items-center justify-between">
                                ...
                                <div class="flex flex-col gap-[2px] items-center justify-center">
                                    <p class="text-sm text-garuda-grey">
                                        {{ number_format($flight->segments->first()->time->diffInHours($flight->segments->last()->time, 0)) }} hours</p>
                                <div class="flex items-center gap-[6px]">
                                    <p class="font-semibold">{{  $flight->segments->first()->airport->iata_code }}</p>
                            ...
                            <div class="time flex flex-col items-center w-[83px]">
                                <div class="h-8 border border-garuda-black border-dashed"></div>
                                <p class="text-xs leading-[18px] text-garuda-grey">{{ number_format($flight->segments->first()->time->diffInHours($flight->segments->last()->time, 0)) }} Hour</p>
                                <div class="h-8 border border-garuda-black border-dashed"></div>
                            </div>
